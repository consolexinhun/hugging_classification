...
from transformers import AutoTokenizer, AdamW, AutoModel, AutoModelForSequenceClassification
...
class MyModel(nn.Module):
    def __init__(self, isFreeze, model_name, hidden_size, num_classes):
        ...
        self.model = AutoModelForSequenceClassification.from_pretrained(model_name, output_hidden_states=True, return_dict=True, num_labels=num_classes)
        if isFreeze:
    ...
    def forward(self, input_ids, attention_mask, token_type_ids):
        ...
        # first_hidden_states = hidden_states[:, 0, :]  # 只需要取第一个单词的输出
